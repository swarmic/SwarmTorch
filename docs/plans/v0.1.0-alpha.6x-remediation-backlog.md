...
Status: Archived for Waves 0-4; reopened for post-Wave7 follow-on tracking (`R9`)  
Date: 2026-02-13  
Updated: 2026-03-11 (post-Wave7 audit addendum)  
...
## Current State Matrix (2026-03-11)

| Backlog slice | State | Closure evidence |
|---|---|---|
| `R1` Build/replay/auth hardening | Closed | [`v0.1.0-alpha.6x-wave0.md`](../release_notes/v0.1.0-alpha.6x-wave0.md), [`v0.1.0-alpha.6x-wave3.md`](../release_notes/v0.1.0-alpha.6x-wave3.md) |
| `R2` no-default/profile coherency + hash/source hardening | Closed | [`v0.1.0-alpha.6x-wave0.md`](../release_notes/v0.1.0-alpha.6x-wave0.md), [`v0.1.0-alpha.6x-wave2.md`](../release_notes/v0.1.0-alpha.6x-wave2.md) |
| `R3` Runtime/observe/artifact integrity | Closed | [`v0.1.0-alpha.6x-wave1.md`](../release_notes/v0.1.0-alpha.6x-wave1.md), [`v0.1.0-alpha.6x-wave3.md`](../release_notes/v0.1.0-alpha.6x-wave3.md) |
| `R4` Aggregation/compression/model guards | Closed | [`v0.1.0-alpha.6x-wave1.md`](../release_notes/v0.1.0-alpha.6x-wave1.md), [`v0.1.0-alpha.6x-wave4.md`](../release_notes/v0.1.0-alpha.6x-wave4.md) |
| `R5` Run-graph/config/topology invariants | Closed | [`v0.1.0-alpha.6x-wave2.md`](../release_notes/v0.1.0-alpha.6x-wave2.md), [`v0.1.0-alpha.6x-wave3.md`](../release_notes/v0.1.0-alpha.6x-wave3.md) |
| `R6` API/error-surface hardening | Closed | [`v0.1.0-alpha.6x-wave3.md`](../release_notes/v0.1.0-alpha.6x-wave3.md), [`v0.1.0-alpha.6x-wave4.md`](../release_notes/v0.1.0-alpha.6x-wave4.md) |
| `R7` Build/MSRV/hygiene cleanup | Closed | [`v0.1.0-alpha.6x-wave2.1.md`](../release_notes/v0.1.0-alpha.6x-wave2.1.md), [`v0.1.0-alpha.6x-wave3.md`](../release_notes/v0.1.0-alpha.6x-wave3.md) |
| `R8` Performance/quality uplift | Closed for Wave scope (`E-01..E-03`) | [`v0.1.0-alpha.6x-wave4.md`](../release_notes/v0.1.0-alpha.6x-wave4.md) |
| `R9` Post-Wave7 scheduler/docs hardening | Closed | [`v0.1.0-alpha.7x-wave1.md`](../release_notes/v0.1.0-alpha.7x-wave1.md), [`v0.1.0-alpha.8x-wave0.md`](../release_notes/v0.1.0-alpha.8x-wave0.md) |

Follow-on feature work proceeds in v0.2 via [`jax_adoption_v0.2.md`](jax_adoption_v0.2.md).
...
## 2026-03-11 Post-Wave7 Audit Addendum (Net-New, Previously Untracked)

### High severity addendum

17. `swarm-torch/src/scheduler.rs` can silently drop nodes when duplicate `node_id` values are present: topological sort builds `node_by_id` with `HashMap::insert` and does not reject duplicates. Duplicate `node_key` values (or crafted duplicate ids) overwrite earlier nodes and produce partial execution/report output without an explicit error.

### Medium severity addendum

18. Scheduler topo-sort relies on production `expect(...)` assertions for map invariants (`node_by_id`, `indegree`, `adjacency`). Corrupt/malformed graphs can hard-panic the process instead of returning typed `SchedulerError`.
19. Release-note chain drift remains in planning docs: references to `docs/release_notes/v0.1.0-alpha.6x-wave2.1.md` are broken in remediation artifacts and should be repaired for audit traceability.

### Low severity addendum

20. `SWARM_TORCH_TECHNICAL_WHITE_PAPER_v0.1.md` still carries a TODO claiming deferred `NodeV1` fields (`op_hash`, `resources`, `cache_policy`, `materialization_policy`) are pending, but Wave7 now ships typed optional fields plus computed `op_hash`; canon docs under-report implemented state.
...
| R9 | Post-Wave7 scheduler/docs hardening | `swarm-torch/src/scheduler.rs`, `swarm-torch-core/src/run_graph.rs`, `docs/plans/*`, `SWARM_TORCH_TECHNICAL_WHITE_PAPER_v0.1.md` | Scheduler rejects duplicate node ids fail-closed; no production panic path in topological scheduling; release-note chain links and NodeV1 implementation status docs are canonicalized. |
