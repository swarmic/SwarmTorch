...
Status: Completed (`A6X-01..A6X-06` landed; retained as execution record)  
Scope: Dataset registry and materialization emitter path (`swarm-torch-core/src/dataops.rs`, `swarm-torch/src/artifacts/*`, `swarm-torch/src/report/*`)  
...
|---|---|---|
| `A6X-01` Emitter correctness invariants | Completed | [`v0.1.0-alpha.6x-wave2.md`](../release_notes/v0.1.0-alpha.6x-wave2.md), `artifacts.rs` invariant tests |
| `A6X-02` Materialization schema v2 + cache evidence | Completed | [`v0.1.0-alpha.6x-wave2.md`](../release_notes/v0.1.0-alpha.6x-wave2.md), `report_loads_materialization_v1_and_v2` |
| `A6X-03` Throughput + durability profiles | Completed | [`v0.1.0-alpha.6x-wave2.1.md`](../release_notes/v0.1.0-alpha.6x-wave2.1.md), snapshot/log replay tests |
| `A6X-04` Descriptor security + unsafe taxonomy | Completed | [`v0.1.0-alpha.6x-wave2.1.md`](../release_notes/v0.1.0-alpha.6x-wave2.1.md), descriptor/unsafe-reason tests |
| `A6X-05` ADR/WP/roadmap conformance lock | Completed | [`v0.1.0-alpha.6x-wave2.1.md`](../release_notes/v0.1.0-alpha.6x-wave2.1.md), doc sync updates |
| `A6X-06` Artifact module decomposition | Completed | [`v0.1.0-alpha.6x-wave6.md`](../release_notes/v0.1.0-alpha.6x-wave6.md), `swarm-torch/src/artifacts/mod.rs`, `swarm-torch/src/report/mod.rs` |
...
10. **Resolved in Wave 6:** former `swarm-torch/src/artifacts.rs` oversized monolith was decomposed into focused modules under `swarm-torch/src/artifacts/*` (plus `swarm-torch/src/report/*`) without schema/API behavior drift.
...
| A6X-06 | Artifact module decomposition (behavior-preserving) | `swarm-torch/src/artifacts/*`, `swarm-torch/src/report/*` | Split artifact/session/write-path logic into smaller modules without changing artifact schema/wire format/API; existing run bundles and `artifact_pipeline` behavior remain compatible. |
...
### A6X-05 Closure Notes (2026-02-13)

- `ADRs.md`: ADR-0016/0017/0018 moved to `Accepted` with explicit implementation status qualifiers and conformance hooks.
- `SWARM_TORCH_TECHNICAL_WHITE_PAPER_v0.1.md`: status matrix and conformance rows reconciled with current implementation reality.
- `ROADMAP.md`: added conformance lock section with baseline gates and contract-probe commands.
